...
\code{kdtree.\{hpp,cpp\}}      & 605 & построяване, трите вида заявка, двата пътя на лист \\
...
\code{benchmarks/bench.cpp}    & 417 & измервания, изход и във формат CSV \\
\code{tests/}                  & 1\,163 & рамка и шест групи проверки, 60 случая \\
\bottomrule
\end{tabular}
\end{table}
