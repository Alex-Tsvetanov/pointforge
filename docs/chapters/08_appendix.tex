...
документ са в публичното хранилище \url{https://github.com/Alex-Tsvetanov/pointforge}. Зависимост: вендориран \code{xsimd}; \code{results/cloud-vm/} не е от отчета.
...
CI на Ubuntu: \code{.github/workflows/ci.yml}.
...
\code{kdtree.\{hpp,cpp\}}      & 625 & построяване, трите вида заявка, трите пътя на лист \\
...
\code{benchmarks/bench.cpp}    & 443 & измервания, изход и във формат CSV \\
\code{tests/}                  & 1\,391 & рамка и шест групи проверки, 60 случая \\
\bottomrule
\end{tabular}
\end{table}
