...
% Глифи за да/не в таблиците за съвпадение с еталона.
\newcommand{\cmark}{\ensuremath{\checkmark}}
\newcommand{\xmark}{\ensuremath{\times}}

% Числата от измерванията, генерирани, за да не може изречение да противоречи на
% таблица. Файлът още не съществува в този проект, затова редът стои закоментиран;
% разкоментира се, когато скриптът за измервания започне да го пише.
% \input{generated/measure_macros}
...
% Съпоставка „еталон | система“ за един и същ вход. Двете изображения се подават
% като пътища, защото имената им зависят от набора от данни.
%   #1 еталонно изображение  #2 изображение от системата  #3 описание  #4 етикет
...
\lstset{
    ...
    emph={point_cloud, depth_image, kd_tree, voxel_grid, knn_result, radius_query,
          stage, pipeline, filter, feature, descriptor, segment, icp_result,
          stereo_matcher, point3f, aabb},
